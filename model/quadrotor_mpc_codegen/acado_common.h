...
/** Matrix of size: 31 x 19 (row major format)
 * 
...
/** Matrix of size: 300 x 16 (row major format) */
real_t Q2[ 4800 ];
...
/** Matrix of size: 90 x 4 (row major format) */
real_t evHu[ 360 ];
...
/** Matrix of size: 90 x 120 (row major format) */
real_t A[ 10800 ];
