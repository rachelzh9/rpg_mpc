...
/* Compute intermediate quantities: */
a[0] = (pow((xd[0]-(real_t)(1.0000000000000000e+00)),2));
a[1] = (pow((xd[1]-(real_t)(1.0000000000000000e+00)),2));
a[2] = ((real_t)(2.0000000000000000e+00)*(xd[0]-(real_t)(1.0000000000000000e+00)));
a[3] = ((real_t)(2.0000000000000000e+00)*(xd[1]-(real_t)(1.0000000000000000e+00)));
